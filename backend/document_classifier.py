...
DOC_TYPES = (
    "Equipment Manual", "Maintenance Report", "Inspection Report",
    "Root Cause Analysis", "Work Order", "Breakdown Report", "Sensor Report",
    "P&ID", "SOP", "Safety Procedure", "General Document",
)

# Only these types offer to update Asset360.
MAINTENANCE_TYPES = frozenset({
    "Maintenance Report", "Inspection Report", "Work Order",
    "Breakdown Report", "Root Cause Analysis", "Sensor Report",
})
